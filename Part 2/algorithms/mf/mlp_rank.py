...
class RankCollaborativeMLP:
    '''
    RankCollaborativeMLP( factors=32, layers=[64,32,16], hidden_act='relu', final_act='sigmoid', batch=100, optimizer='adam', learning_rate=0.001, reg=0.01, layer_reg=0.01, emb_reg=0.01, dropout=0.0, epochs=10, include_artist=False, embeddings=None, folder=None,  order='random', session_key = 'playlist_id', item_key= 'track_id', user_key= 'playlist_id', artist_key= 'artist_id', time_key= 'pos' )

    Parameters
    -----------
    '''
    
    def __init__( self, factors=32, layers=[64,32,16], hidden_act='relu', final_act='sigmoid', batch=100, optimizer='adam', learning_rate=0.001, reg=0.01, layer_reg=0.01, emb_reg=0.01, dropout=0.0, epochs=10, include_artist=False, embeddings=None, folder=None,  order='random', session_key = 'playlist_id', item_key= 'track_id', user_key= 'playlist_id', artist_key= 'artist_id', time_key= 'pos' ):
    ...
    def get_pmodel(self):
        ...
        emb_user = Embedding( output_dim=self.factors, input_dim=self.num_users, embeddings_regularizer=l2(self.emb_reg), trainable=trainable )
        emb_item = Embedding( output_dim=self.factors, input_dim=self.num_items, embeddings_regularizer=l2(self.emb_reg), trainable=trainable )
